        ...
        <section className="bg-simple-bg relative before:absolute before:w-full before:h-full before:bg-arrow-bg before:bg-no-repeat before:top-10">
            <div className="">
                <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md px-4 relative z-10">
                    ...
                    <p className="text-center text-white/40 text-lg font-normal mb-8">Easily buy and sell cryptocurrency on secure platforms like Binance, Coinbase, and Kraken. Enjoy fast transactions, strong security, and user-friendly interfaces.</p>
