...
const ContactUs = () => {
  ...
  return (
    <div 
      id="contact"
      className=" bg-gradient-to-b from-indigo-800 to-gray-700 w-full "
    >
      <div className="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif] max-w-screen-xl mx-auto">
        <div className="max-w-screen-xl mx-auto">
          ...
          <ul className="flex mt-12 space-x-4">
            <li className="bg-gradient-to-tr from-teal-400/60 to-amber-500/60 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
        ...
        <div className=" bg-gradient-to-b from-white/30 to-indigo-900 p-6 rounded-lg">
          ...
          {/* <div className="space-y-4 max-lg:mt-4">
            <button
              type="button"
              className="px-4 py-2 rounded-full bg-[#a91079] text-white text-sm tracking-wider font-medium outline-none border-2 border-[#a91079] mr-4"
            >
              Web design
            </button>
            <button
              type="button"
              className="px-4 py-2 rounded-full bg-transparent text-gray-800 text-sm tracking-wider font-medium outline-none border-2 border-gray-300 mr-4"
            >
              Graphic design
            </button>
            <button
              type="button"
              className="px-4 py-2 rounded-full bg-transparent text-gray-800 text-sm tracking-wider font-medium outline-none border-2 border-gray-300"
            >
              Design system
            </button>
          </div> */}
