            ...
            <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md px-4 relative" id="features-section">
                ...
                <div className=" flex items-center justify-center">
                    ...
                    <div>
                        ...
                        <p className="lg:text-lg font-normal text-white text-center md:text-start">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry standard dummy text ever since the 1500s.</p>
                    </div>
                    {/* Column-2 */}
                    <div>
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-x-4 gap-y-4">
                            {Featuresdata.map((items, i) => (
                                <div className="bg-darkmode py-10 pr-12 pl-6 rounded-lg" key={i}>
                                    ...
                                    <p className="text-white text-sm font-normal">{items.subheading}</p>
                                </div>
                            ))}
                        </div>
                    </div>
